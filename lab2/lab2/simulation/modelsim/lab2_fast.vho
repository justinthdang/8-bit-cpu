...
-- Equation(s):
-- \f~0_combout\ = (\x2~combout\ & (\x4~combout\ $ (((\x3~combout\) # (\x1~combout\))))) # (!\x2~combout\ & ((\x4~combout\ & (\x3~combout\ & \x1~combout\)) # (!\x4~combout\ & ((!\x1~combout\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0100101000101101",
